...
export default function SEOManager() {
  ...
  useEffect(() => {
    ...
    let title = 'BUNNIES UNIVERSE | Unofficial NewJeans Interactive World & Fan Portal';
    ...
    if (path === '/') {
      title = 'BUNNIES UNIVERSE | Unofficial NewJeans Interactive World & Fan Portal';
      ...
      title = 'NewJeans Members Profile & MBTI (Minji, Hanni, Haerin, Hyein, Danielle) | BUNNIES UNIVERSE';
      ...
      title = 'Minji (NewJeans) Profile, MBTI & Photo Gallery | BUNNIES UNIVERSE';
      description = 'Explore Minji (Kim Min-ji) profile, ESTJ MBTI, vocal tone, leader bio, photocards, and favorite NewJeans songs on Bunnies Universe.';
    } else if (path.startsWith('/members/hanni')) {
      title = 'Hanni (NewJeans) Profile, MBTI, Lyrics & Bio | BUNNIES UNIVERSE';
      description = 'Explore Hanni Pham profile, INFP MBTI, songwriting achievements (Hype Boy, OMG), sweet vocals, and photocards on Bunnies Universe.';
    } else if (path.startsWith('/members/haerin')) {
      title = 'Haerin (NewJeans) Profile, MBTI & Main Dancer Bio | BUNNIES UNIVERSE';
      description = 'Explore Haerin (Kang Hae-rin) profile, ISTP MBTI, cat-like feline visuals, dance performance controls, and photocards on Bunnies Universe.';
    } else if (path.startsWith('/members/hyein')) {
      title = 'Hyein (NewJeans) Profile, MBTI & R&B Vocals Bio | BUNNIES UNIVERSE';
      description = 'Explore Hyein (Lee Hye-in) profile, INFP MBTI, soulful R&B vocals, model proportions, and photocards on Bunnies Universe.';
    } else if (path.startsWith('/members/danielle')) {
      title = 'Danielle Profile & Former Member Archive | BUNNIES UNIVERSE';
      description = 'Explore Danielle Marsh profile, ENFP MBTI, sunshine energy, Disney visuals, and official former member fandom archive on Bunnies Universe.';
    } else if (path === '/discography') {
      title = 'NewJeans Discography & Song Audio Previews (Ditto, Super Shy, How Sweet) | BUNNIES UNIVERSE';
      ...
      title = 'NewJeans Career Timeline (2022-2026 Milestones & Achievements) | BUNNIES UNIVERSE';
      ...
      title = 'BUNNIES UNIVERSE | Interactive World & Bunny Affinity Calculator';
      ...
      description = 'Stay updated with official NewJeans press releases, music production records, chart milestones, awards, and Bunnies Universe platform updates.';
    } else if (path === '/about') {
      title = 'NewJeans Encyclopedia & Group Naming Philosophy | BUNNIES UNIVERSE';
